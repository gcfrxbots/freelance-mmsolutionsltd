...
defaultSettings = [
    ("DELAY MODIFIER", "9", "9 by default. Raise this value to make it click further to the left, and lower it to make it click further to the right."),
    ("PUTT DELAY MODIFIER", "9", "9 by default. Raise this value to make it click further to the left, and lower it to make it click further to the right."),
    ("ACCURACY MODIFIER", "0", "0 by default. Determines how accurately the bot senses the pixel's colors. Raise to increase sensitivity and accuracy, decrease if it doesn't click."),
